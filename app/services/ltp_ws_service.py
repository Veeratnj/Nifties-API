...
def start_ltp_websocket(token: str, app, callback=None):
    ...
    dhan_context = DhanContext('1100465668', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJkaGFuIiwicGFydG5lcklkIjoiIiwiZXhwIjoxNzY3MTQ5NjM4LCJpYXQiOjE3NjcwNjMyMzgsInRva2VuQ29uc3VtZXJUeXBlIjoiU0VMRiIsIndlYmhvb2tVcmwiOiIiLCJkaGFuQ2xpZW50SWQiOiIxMTAwNDY1NjY4In0.TI0E_5JVH_FT4Kd3ETXWkfc3Mqh6TDAh79nO9MZzl1pRbutbJ1yPOt4hb1SHM9I8oRr09klIXARUQ_AbjqJmMQ')
